...
class PostProcessing(object):
    ...
    def ls_error(self, n_agents, t1, t2, num_points):
        ...
        for i in range(t1, t2-1):
            ...
            restart_data = os.path.join(dir_path, self.params.filename + str(i) + ".pcl")
            ...
            # Load the model from the previous iteration step
            dir_path = os.path.dirname(os.path.realpath(__file__))
            restart_data = os.path.join(dir_path, self.params.filename + str(i+1) + ".pcl")
